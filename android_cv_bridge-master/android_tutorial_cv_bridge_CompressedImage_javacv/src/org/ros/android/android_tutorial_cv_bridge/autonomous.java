...
//    }
    ...
    public autonomous(MainActivity mainActivity){
    ...
    public void onStart(final ConnectedNode connectedNode) {
        final Publisher<std_msgs.Float32> publisher =
                connectedNode.newPublisher("autonomous", std_msgs.Float32._TYPE);
...
//                }
            ...
            protected void loop() throws InterruptedException {
                ...
                if (mainActivity.autonomous_status == 1){
                    str.setData(1);
                    publisher.publish(str);
                    mainActivity.autonomous_status=0;
                }
                else {
                    str.setData(0);
                    publisher.publish(str);
